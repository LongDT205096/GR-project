...
function Latest({ params }: { params: { genreid: string, pageid: string } }) {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const api = requests.fetchMoviesByGenre + params.genreid + "/?page=" + params.pageid;
                const moviesByGenre = await axios.get(api)
                    .then((response) => {
                ...
                const data = await moviesByGenre;
    ...
    const handlePageChange = (newPage: string) => {
        ...
        router.push(`/genre/${params.genreid}/page/${newPage}`);
    };
