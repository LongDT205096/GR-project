            ...
            <div className="embla__viewport overflow-hidden" ref={emblaRef}>
                <div className="embla__container flex space-x-2 transition-transform duration-300">
                    {reviewData && reviewData.map((review: any) => (
                        <div className='md:w-[250px] h-52 overflow-hidden p-3 ml-5 rounded-lg bg-neutral-700 embla__slide review_slide flex-none' key={review.id}>
                            <h3 className='text-xl font-bold'>{review.account}</h3>
                    ...
                    <div className='overflow-y-scroll h-[75vh] w-full max-w-5xl p-6 mx-auto divide-y rounded-md border-white border-2 pt-4 pl-4 flex flex-col'>
                        <div className="flex justify-between p-4">
                            <div className="flex space-x-4">
                                <div>
                                    <h4 className="font-bold text-3xl">{fullReview.account}</h4>
                                    <span className="text-2xl dark:text-gray-600">2 days ago</span>
                                </div>
                            </div>
                        ...
                        <div className="p-4 space-y-2 dark:text-gray-600">
                            <p className='text-2xl'>Title: {fullReview.title}</p>
                            <p className='text-2xl'>Review:</p>
                            <p className='text-xl'>{fullReview.content}.</p>
                        </div>
                    </div>
                </div>
            </div>)}
